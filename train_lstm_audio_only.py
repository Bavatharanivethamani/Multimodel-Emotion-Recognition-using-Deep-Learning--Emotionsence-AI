...
def train_lstm_audio(X, y, device, num_epochs=25, lr=1e-4):
    print("\n" + "="*60)
    print("🚀 LSTM AUDIO EMOTION RECOGNITION TRAINING")
    print("="*60)
    ...
    print("\n" + "="*60)
    print("📊 LSTM AUDIO FINAL RESULTS")
    print("="*60)
...
def main():
    ...
    metrics = train_lstm_audio(X, y, device, num_epochs=25, lr=1e-4)
    print("\n" + "="*60)
