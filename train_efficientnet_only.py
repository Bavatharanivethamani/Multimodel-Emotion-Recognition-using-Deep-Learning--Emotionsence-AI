...
def train_efficientnet(dataloaders, device, num_epochs=25, lr=1e-4):
    print("\n" + "="*60)
    print("EFFICIENTNET-B0 EMOTION RECOGNITION TRAINING")
    print("="*60)
    ...
    # Save model
    torch.save(model.state_dict(), 'best_efficientnetb0_emotion.pth')
    print("Model saved as 'best_efficientnetb0_emotion.pth'")
...
def main():
    ...
    metrics = train_efficientnet(dataloaders, device, num_epochs=25, lr=1e-4)
